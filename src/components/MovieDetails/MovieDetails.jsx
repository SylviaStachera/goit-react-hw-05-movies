...
const MovieDetails = () => {
	...
	const { poster_path, title, release_date, vote_average, overview, genres } = details;
		...
		<div className={css.container}>
			...
			<div className={css["box"]}>
				<img
					...
					src={poster_path ? `https://image.tmdb.org/t/p/w300${poster_path}` : <p>No poster, sorry!</p>}
					alt={overview}
					loading="lazy"
				/>
